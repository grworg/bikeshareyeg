    ...
    return (
      <div className="flex flex-col h-full bg-[var(--color-surface)]">
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-200 bg-[var(--color-surface)] sticky top-0 z-10 shrink-0">
          ...
          <span className="text-[14px] font-semibold text-gray-900 truncate">City Proposal</span>
        </div>
        ...
        <MobileDocsDrawer open={drawerOpen} onClose={() => setDrawerOpen(false)} title="Proposal Sections">
